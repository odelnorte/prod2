...
echo"<tr ".$background."><td class='tt' id='tdPedidoLista".$row["solicitud_refaccionid"]."' title='".$row["solicitud_refaccionid"]."' onClick='mostrarPedido(".$row["solicitud_refaccionid"].", ".$row["estatusidfk"].");cambiaColorPedido(".$row["solicitud_refaccionid"].")'>".$row["solicitud_refaccionid"]."  &nbsp; ".$row["sala2"]."  &nbsp;  ".$marcado."<span class='tooltip'><span class='top'></span><span class='middle'>Folio: ".$row["folio_solicitudidfk"]."</br>Sala: ".$row["sala"]."</br>Tecnico: ".$tec["tecnico"]."</br>Fecha: ".$row["fecha_creacion"]."</br>Operador: ".$row["usuario"]."</br>Comentarios: ".$row["observaciones"]."</span><span class='bottom'></span></span></td>";
echo"</tr>";

}else{
	
echo"<tr ".$background."><td class='tt' id='tdPedidoLista".$row["solicitud_refaccionid"]."' title='".$row["solicitud_refaccionid"]."' onClick='mostrarPedidoSinFolio(".$row["solicitud_refaccionid"].", ".$row["estatusidfk"].");cambiaColorPedido(".$row["solicitud_refaccionid"].")'>".$row["solicitud_refaccionid"]."  &nbsp; ".$row["sala2"]."  &nbsp;  ".$marcado."<span class='tooltip'><span class='top'></span><span class='middle'>Folio: ".$row["folio_solicitudidfk"]."</br>Sala: ".$row["sala"]."</br>Tecnico: ".$tec["tecnico"]."</br>Fecha: ".$row["fecha_creacion"]."</br>Operador: ".$row["usuario"]."</br>Comentarios: ".$row["observaciones"]."</span><span class='bottom'></span></span></td>";
echo"</tr>";
}$marcado='';$background='';
}
echo "</table>";
